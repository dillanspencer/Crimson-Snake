...
public class Board {
    ...
    private void applyMove(Tile[][] board, Snake snake, Move move){
        ...
        if(move == Move.UP){
            board[(snake.getHead().getX() - 1)][snake.getHead().getY() - 1] = Tile.HEADS;
            board[(snake.getHead().getX() - 1)][snake.getHead().getY()] = Tile.WALL;
            snake.setHead(new Point((snake.getHead().getX() - 1), snake.getHead().getY() - 1));
        }
            ...
            board[(snake.getHead().getX() - 1) - 1][snake.getHead().getY()] = Tile.HEADS;
            board[(snake.getHead().getX() - 1)][snake.getHead().getY()] = Tile.WALL;
            snake.setHead(new Point((snake.getHead().getX() - 1) - 1, snake.getHead().getY()));
        }
